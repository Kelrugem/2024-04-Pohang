...
%
%\begin{frame}
\begin{remark}[Based on the following works]
\begin{enumerate}
...
%Journal de l'\'Ecole Polytechnique, (2021).
  %\item Camille Laurent-Gengoux et Leonid Ryvkin, \textit{The holonomy of a singular leaf}, Selecta Mathematica, (2022). 
	\item S.-R.\ F.\ and Camille Laurent-Gengoux, \textit{Classification of neighborhoods around leaves of singular foliations}, arXiv:2401.05966, (2024).
...
\begin{center}
	...
	\text{Foliation } \mathcal{F} \arrow{r} \arrow[bend left, color = red]{r}{\text{formal}} \& \arrow[bend left, color = MyDarkBlue]{l}{\text{does not need to be formal}} \arrow{l} \text{Classification}
	\end{tikzcd}
\end{center}
\end{frame}
